...
// Adapted for QML script import
// Create an internal fuzzysort module and expose its functions as top-level
var _fuzzysort = (function() {
    'use strict'
...
// Expose functions for QML `import ".../fuzzysort.js" as FuzzySort` usage
function single(search, target) { return _fuzzysort.single(search, target) }
function go(search, targets, options) { return _fuzzysort.go(search, targets, options) }
function prepare(target) { return _fuzzysort.prepare(target) }
function cleanup() { return _fuzzysort.cleanup() }